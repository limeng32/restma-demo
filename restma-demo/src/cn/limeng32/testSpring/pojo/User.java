...
import cn.limeng32.testSpring.annotation.Status;
...
public class User extends PojoSupport<User> implements Serializable {
	...
	public void addArticle(Article newArticle) {
		...
		if (!newArticle.belongs(this.article)) {
			// newArticle.belongs(this.article)
			// PojoUtil.contains(this.article, newArticle)
			// this.article.contains(newArticle)
	...
	public void removeArticle(Article oldArticle) {
		...
		if (this.article != null)
			if (oldArticle.belongs(this.article)) {
				// this.article.contains(oldArticle)
				// oldArticle.belongs(this.article)
