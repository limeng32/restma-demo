...
<link rel="stylesheet" href="${resourceRoot}/css/common.css" type="text/css">
<script type="text/javascript" src="${resourceRoot}/js/jquery-1.6.2.min.js"></script>
<script type="text/javascript" src="${resourceRoot}/js/asd.js"></script>
</head>
<body>
	<fmt:message key="test.title" />:<fmt:message key="test.vol" />
	...
	<form method="post" action="<c:url value="/test/handle41?"/>">
		...
		呵呵：<input type="text" name="hehe" /><br />
	...
	<form:form modelAttribute="user">
		...
		<form:radiobuttons path="sex" delimiter=" | " items="${genders}" itemValue="value" itemLabel="label"/>
	</form:form>
